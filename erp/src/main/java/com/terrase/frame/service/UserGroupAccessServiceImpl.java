...
public class UserGroupAccessServiceImpl extends EntityServiceImpl<UserGroupBranchAccess> implements UserGroupAccessService {

	@Autowired
	private UserGroupAccessDAO classDAO;

	@Override
	public EntityDAO<UserGroupBranchAccess> getClassDAO() {
		return classDAO;
	}
}
